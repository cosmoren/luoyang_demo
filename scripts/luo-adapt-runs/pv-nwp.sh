...
#SBATCH --output=/shared_work/erfan/logs/luo-pv-nwp_%j.log
#
# Connect to the Slurm server (from local machine):
#   ssh erfan@207.35.188.227 -p 2221
#
# Luoyang 15m DINOv2 train (PV + NWP; sky hard-zeroed). Layout:
...
#   sbatch /shared_work/erfan/codebases/fol-luo-SR1/scripts/luo-adapt-runs/pv-nwp.sh
