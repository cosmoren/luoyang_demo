#!/usr/bin/env bash
#SBATCH --job-name=luo-pv-sky-nwp
...
#SBATCH --output=/shared_work/erfan/logs/luo-pv-sky-nwp_%j.log
#
# Connect to the Slurm server (from local machine):
#   ssh erfan@207.35.188.227 -p 2221
#
# Weekend Luoyang 15m DINOv2 train (pv + sky + NWP). Layout:
...
#   sbatch /shared_work/erfan/codebases/fol-luo-SR1/scripts/luo-adapt-runs/pv-sky-nwp.sh
