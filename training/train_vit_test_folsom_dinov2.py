...
from models.models import (  # noqa: E402
    ...
    pv_forecasting_model_vit_dinov2,
)
...
# Legacy note: vit_imgs once remapped Folsom NWP slots; dinov2 path zeros NWP by default.
...
def _build_parser(h: dict, config_default: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "pv_forecasting_model_vit_dinov2 (also fixes the model's query_mlp input dim). "
