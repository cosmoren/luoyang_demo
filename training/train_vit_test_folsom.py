...
Uses ``dataloader.folsom.FolsomIrradianceDataset`` (Zarr skies, merged NWP, Luoyang-shaped
``collate_folsom_vit_batch`` batches). Sky imagery is always the Zarr store at ``paths.sky_image_path``.
